...
with recent applications of Transformers (originally used in NLP) to images, see ![link](https://openreview.net/pdf?id=YicbFdNTTy), maybe this might be of great use here. After all, when a human looks at a chess board, we don't look at all pieces and squares equally, but focus our attention (!) on the ones relevant for tactics etc. I will try it out, stay tuned!
